  ...
  <div>
      ...
      <div class="product-option">
        ...
        <div class="options">
          <div class="option-item" @click.prevent.stop="togglePricePicker">
            <div class="thumb">
              <svg viewBox="0 0 123 98" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path fill-rule="evenodd" clip-rule="evenodd"
                      ...
                      fill="#59D0FF"/>
                <rect x="51.3722" y="29.3109" width="4.92358" height="25.1858" rx="2.46179"
                      transform="rotate(10.3499 51.3722 29.3109)" fill="white"/>
              </svg>
            </div>
            Pick Your Price
          </div>
          <div class="option-item" @click.stop="toggleBuyNow">
            <div class="thumb">
          ...
          <div class="option-item" @click.stop="toggleNebulaPay">
            <div class="thumb">
              <svg viewBox="0 0 57 78" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd"
          ...
          <div class="option-item" @click.stop="toggleFlex">
            <div class="thumb">
              <svg viewBox="0 0 68 79" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="6.72684" y="21.456" width="56.6896" height="8.09851" rx="4.04926"
                      transform="rotate(-21.5771 6.72684 21.456)" fill="url(#paint0_linear)"/>
                <rect x="12.0877" y="35.0118" width="56.6896" height="8.09851" rx="4.04926"
                      transform="rotate(-21.5771 12.0877 35.0118)" fill="url(#paint1_linear)"/>
                <rect x="6.15198" y="53.035" width="35.6334" height="8.09851" rx="4.04926"
                      transform="rotate(-21.5771 6.15198 53.035)" fill="url(#paint2_linear)"/>
                <rect x="0.2164" y="71.0582" width="35.6334" height="8.09851" rx="4.04926"
                      transform="rotate(-21.5771 0.2164 71.0582)" fill="url(#paint3_linear)"/>
                <defs>
                  <linearGradient id="paint0_linear" x1="60.9377" y1="27.3737" x2="9.46622" y2="27.5752"
                                  gradientUnits="userSpaceOnUse">
                    <stop stop-color="#FF5C00"/>
                    <stop offset="1" stop-color="#FF0000"/>
                  </linearGradient>
                  <linearGradient id="paint1_linear" x1="65.7688" y1="42.1312" x2="14.2973" y2="42.3327"
                                  gradientUnits="userSpaceOnUse">
                    <stop stop-color="#FF5C00"/>
                    <stop offset="1" stop-color="#FF0000"/>
                  </linearGradient>
                  <linearGradient id="paint2_linear" x1="39.893" y1="60.2964" x2="6.95676" y2="59.8337"
                                  gradientUnits="userSpaceOnUse">
                    <stop stop-color="#FF5C00"/>
                    <stop offset="1" stop-color="#FF0000"/>
                  </linearGradient>
                  <linearGradient id="paint3_linear" x1="34.9183" y1="77.5909" x2="0.603933" y2="77.7253"
                                  gradientUnits="userSpaceOnUse">
                    <stop stop-color="#FF5C00"/>
                    <stop offset="1" stop-color="#FF0000"/>
                  </linearGradient>
    ...
    <heylo-modal ref="modal" @onModalClose="reset">
      <template slot-scope="props">
        <single-product-price-picker v-if="picker"/>
        <single-product-nebula-pay v-else-if="nebula"/>
        <coming-soon v-else/>
      </template>
    </heylo-modal>
  </div>
    ...
    .product-option {
      ...
      .options {
        ...
        .option-item {
          ...
          line-height: 26px;
          color: #000000;
          @apply flex items-center px-6 mt-6 py-3 rounded-full;
          &:hover {
            @apply bg-gray-100;
          }
          ...
          .thumb {
            ...
            position: relative;
            overflow: hidden;
            @apply object-fill object-center mr-8 rounded-lg;
